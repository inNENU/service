...
type MiniProgramLoginResponse = { openid: string; session_key: string } | WechatErrorResponse;
...
export const mpLoginHandler = request<MPLoginResponse, MPLoginOptions>(async (req, res) => {
