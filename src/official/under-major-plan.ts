...
export type UnderMajorPlanResponse = UnderMajorPlanSuccessResponse | CommonFailedResponse;
...
export const underMajorPlanHandler = request<UnderMajorPlanResponse>(async (_, res) =>
  res.json(await getUnderMajorPlan()),
);
