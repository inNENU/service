...
import type { SelectProcessOptions, SelectProcessResponse } from "../../study/select/index.js";
import { GRAD_STUDY_SERVER } from "../utils.js";

export const gradSelectProcessHandler = request<SelectProcessResponse, SelectProcessOptions>(
  async (req, res) => {
    ...
    if (type === "add")
      return res.json(await addSelectCourse(req.body, cookieHeader, GRAD_STUDY_SERVER));
    if (type === "remove")
      return res.json(await removeSelectCourse(req.body, cookieHeader, GRAD_STUDY_SERVER));
