...
export interface RawUnderSelectClassItem {
   ...
   *
   * @example
   *   "Outline 0f Xi JinPing’s New China’s Socialist Ideology";
   */
  kcywmc: string;
  /**
   * 开课单位
   ...
   *
   * @example
   *   "物理学院116室,物理学院113,物理学院204室,电学实验五室（222室）,电学实验三室（218室）,力热实验二室（201室）,力热实验三室（229室）,力热实验五室（245室）,电学实验二室（217室）,光学实验一室（216室）,力热实验六室（227室）";
   */
  jxcdmcs: string;
  /**
